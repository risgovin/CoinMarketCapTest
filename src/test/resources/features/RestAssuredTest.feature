...
Feature: Rest Assured Test
    ...
    Scenario: Ethereum Validation
        ...
        And The element "data.1027.urls.technical_doc" should be "[https://github.com/ethereum/wiki/wiki/White-Paper]"
        And The element "data.1027.symbol" should be "ETH"
        And The element "data.1027.date_added" should be "2015-08-07T00:00:00.000Z"
        And The element "data.1027.tags" should contain "mineable"
    @rest3
